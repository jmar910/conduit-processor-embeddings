module example.com/conduit-processor-embeddings
...
require (
	...
	github.com/conduitio/conduit-commons v0.0.1 // indirect
	github.com/conduitio/conduit-processor-sdk v0.1.0 // indirect
